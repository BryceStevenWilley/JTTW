...
DisappearingPlatform::DisappearingPlatform(std::string &fileName, cocos2d::Vec2 center, cocos2d::Size imageSize, cocos2d::Vec2 box, bool climeable, bool collidable) :  Platform(fileName, center, imageSize, box, climeable, collidable) {
...
DisappearingPlatform::DisappearingPlatform(std::string &fileName, cocos2d::Vec2 center, cocos2d::Size imageSize, std::vector<cocos2d::Vec2> points, bool climeable, bool collidable) :  Platform(fileName, center, imageSize, points, climeable, collidable) {
    _maxX = center.x + imageSize.width / 2.0;
    _minX = center.x - imageSize.width / 2.0;
    _maxY = center.y + imageSize.height / 2.0 + 30;
    _minY = center.y - imageSize.width / 2.0;
